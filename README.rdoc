...
NOTE: MongoMapper as of version 0.8.2 has a small bug that we need to patch so we can use $or in our queries.  See
   http://github.com/rlivsey/plucky/commit/956a3d456c429b4aa0d9ef54965e73dd15811e4e
for more info and the changes needed.

== Database
MongoDB doesn't require much setup - it creates collections the first time they're written to, so just make sure it's running on your machine.

If you're new to MongoDB the tutorial is very helpful:
   http://www.mongodb.org/display/DOCS/Tutorial
and the Ruby driver tutorial is, too:
